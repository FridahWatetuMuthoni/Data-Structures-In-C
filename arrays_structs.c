...
/*
In C, you can declare an array of structures by preceding the array name with the structure name.
For instance, given a structure with the tag name of x, the following statement:
